...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"📲 Kanalimiz",'url'=>"https://t.me/Lider_Xakkerlar"],['text'=>"🔥 Dasturchi",'url'=>"https://t.me/Coder_Prince"]]
]
])
]);
}else{
...
'chat_id'=> $cid,
'parse_mode'=>"html",
'text'=>"🔵 <b>Kechirasiz</b> <a href='tg://user?id=$cid'>$name</a> <b>Botdan to'liq Foydalanish uchun</b> <a href='t.me/Lider_Xakkerlar'>@LIDER_XAKKERLAR</a> <b>Kanaliga ➕ A'zo bo'ling va ✅ Tekshirish tugmasini bosing!

📛 Agar kanaldan chiqib ketsangiz bot sizning guruhda ishlamay qoladi.</b>",
'disable_web_page_preview'=>true,
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"➕ A'zo bo'lish",'url'=>"t.me/Lider_Xakkerlar"]],
...
'text'=>"📛 Siz @LIDER_XAKKERLAR Kanalimizga A'zo bo'lmadingiz!",
'show_alert'=>true,
]);
}
}
...
if ($tx == "/mymembers" or $tx == "/mymembers@GRJOIN_UZBOT"){
if ($cty == "supergroup"){
if (!$replyid){
bot ('sendmessage', [
'chat_id'=> $cid,
...
if ($tx == "/top" or $tx == "/top@GRJOIN_UZBOT"){
 if ($cty == "supergroup"){
$reyting = top($cid);
bot ('sendmessage', [
'chat_id'=> $cid,
...
✅<b>Namuna:</b>
<i>/setchannel @Lider_Xakkerlar</i>",
'reply_to_message_id'=> $mid,
]);
}
}

if ($tx == "/setchannel" or $tx == "/start" or $tx == "/setchannel@GRJOIN_UZBOT" or $tx == "/stat"){
if ($cty == "supergroup"){
$us = bot ('getChatMember', [
'chat_id'=> $chan,
'user_id'=> $uid,
